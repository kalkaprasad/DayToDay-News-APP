...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ExamviewHolder> {
    public List<NewsData> emExampleList; // new List<List>();
    ...
    public static class ExamviewHolder extends  RecyclerView.ViewHolder {  //  here  we are   excletends the  method the Recycle view..
      ...
      public void onBindViewHolder(@NonNull ExamviewHolder holder, int position) {
          final NewsData currentitem=emExampleList.get(position);
          // it is  use the  hold the data and set the data to text view or id ..
         ...
         ;// holder
          ...
          holder.myclick.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View view) {
                  ...
                  Intent i= new Intent(mcontext,treandingNews.class);
