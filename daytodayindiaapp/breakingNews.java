...
public class breakingNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView=findViewById(R.id.breakingnewslist);
        progressBar =findViewById(R.id.breakingprogresbar);
        postre = FirebaseDatabase.getInstance().getReference().child("New record").child("Breaking news");
...
;
                    NewsAdapter adapter=new NewsAdapter(breakingNews.this,examplelist);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(breakingNews.this, "data not found", Toast.LENGTH_SHORT).show();
