...
public class DeleteAdapter extends RecyclerView.Adapter<DeleteAdapter.ExamviewHolder> {
    ...
    public static class ExamviewHolder extends  RecyclerView.ViewHolder {  //  here  we are   excletends the  method the Recycle view..
      ...
      public void onBindViewHolder(@NonNull ExamviewHolder holder, int position) {
          ...
          // picasso are library   use for the load image from url..
          holder.myclick.setOnClickListener(new View.OnClickListener() {
              @Override
              public void onClick(View view) {

                  Intent i= new Intent(mcontext,DistroyActivity.class);
                  i.putExtra("title",currentitem.getTitle());
                  i.putExtra("desc",currentitem.getDiscription());
                 i.putExtra("myid",currentitem.getMyid());
                i.putExtra("parent",currentitem.getCategory());
                 i.putExtra("imgurl",currentitem.getImgurl());
                 mcontext.startActivity(i);
                  ((Deletelist)mcontext).finish();
